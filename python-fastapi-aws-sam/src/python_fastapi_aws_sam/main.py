...
from python_fastapi_aws_sam import version_str
from python_fastapi_aws_sam.config import swagger_servers, cors_origins, FASTAPI_ROOT_PATH
from python_fastapi_aws_sam.controllers import activity, fruits, vegetables
